...
const GameByCategoryId = ({ gameList }) => {
  useEffect(() => {
  ...
  return (
    <div>
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-5">
        {gameList.map((item) => (
          <div className=" bg-[#76a8f75e] p-3 rounded-lg pb-12 h-full hover:scale-110 transition-all ease-in-out duration-200 cursor-pointer">
            <img
...
export default GameByCategoryId;
